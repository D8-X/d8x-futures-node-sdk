...
* [BrokerTool](#BrokerTool)
    ...
    * [.transferOwnership(newAddress)](#BrokerTool+transferOwnership)
...
### brokerTool.transferOwnership(newAddress)
...
| Param | Description |
| --- | --- |
| newAddress | <p>The address this broker wants to use from now on.</p> |
